# ReAQ (Android)
ReAQ es una herramienta de aprendizaje desarrollada en **Unity 2019.4** para enfocarse en aprender sobre enlaces químicos. Está diseñada y probada en dispositivos Android 13 o superior. 
- **Plataforma:** Android (APK)
- **Versión mínima de Android:** Android 9 o superior
...
- **SQlite 3.51** *(se importa a través del Menu Assets, import package, custom package).

## Vuforia (Package Manager)
Este proyecto usa **Vuforia Engine 8.5.20** a través de Unity Package Manager.
...
- Dispositivo Android con **Android 9+**
...
- `Assets/StreamingAssets/`  
  Archivos que deben enviarse tal cual con la compilación (configuraciones, medios o recursos de tiempo de ejecución) y la base de datos local.
- `Assets/Plugins/`  
...
- **Datos:** Integraciones de SQLite (v1)
